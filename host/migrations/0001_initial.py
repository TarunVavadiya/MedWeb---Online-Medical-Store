# Generated by Django 4.1.7 on 2023-04-03 07:18
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "Status",
                    models.CharField(
                        choices=[("0", "INACTIVE"), ("1", "ACTIVE")], max_length=10
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "L_id",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="host.login"
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "Area_id",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="host.area"
                    ),
                ),
                (
                    "City",
                ...
                (
                    "State_id",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="host.state"
                    ),
                ),
            ],
        ),
